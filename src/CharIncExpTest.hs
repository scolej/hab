...
incExpSimple =
  ...
  in TestCase $ assertEqual "Character should advance to level 2."
...
incExpSimple2 =
  ...
  in TestCase $ assertEqual "Character should advance to level 2 with a bit left over."
...
incExpOverflow =
  ...
  in TestCase $ assertEqual "Character should advance to level 3."
...
incExpOverflow2 =
  ...
  in TestCase $ assertEqual "Character should advance to level 3 with a bit left over."
             (CharState fullHealth 1 3)
             (deriveCharacter mods blankCharacter)

main :: IO Counts
main = runTestTT $ TestList [ lvlExp1
                            , incExpSimple
                            , incExpSimple2
                            , incExpHeal
                            , incExpOverflow
